...
data class SignupRequest(    val method: String,val fname: String, val lname: String , val email: String, val password: String, val mobile: String,val device_token:String)
